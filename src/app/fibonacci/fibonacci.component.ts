...
export class FibonacciComponent implements OnInit {
  ...
  plano() {
    ...
    ctx.lineTo(centroX, this.canvas.height);
    ctx.moveTo(0, centroY);
    ctx.lineTo(this.canvas.width, centroY);
    ctx.stroke();
    ...
    // ctx.quadraticCurveTo(200, this.C, this.x2.value, 200);
    // ctx.stroke();
    ...
    // ctx.lineWidht = 10;
    // ctx.moveTo(20, 20);
    // ctx.quadraticCurveTo(20, 500, 200, 20);
